...
should_assertions_count = 0;

Object.defineProperty(Object.prototype, 'should', {  // Extend the Object.prototype.should
	get: function(){
		should_assertions_count++;
		return new should.Assertion(this);
	},
});
...
printRunnerResults = function(runner){
  ...
  //msg += results.totalCount + ' assertion' + ((results.totalCount === 1) ? '' : 's') + ', ';
	msg += (results.totalCount+should_assertions_count) + ' assertion' + ((results.totalCount === 1) ? '' : 's') + ', ';
